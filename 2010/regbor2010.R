...
setwd("C:/Users/Alyssa/Box Sync/Programming Projects/IMLS Data/Registered-Borrower-Visits/2010")

#load data
states <- read.csv("pusum10a.csv")
...
#save this new dataset as a csv
write.csv(states, file="regbor2010.csv")

#Make a map of the raw total visits per state
state_choropleth(states, title="visits per registered borrower: 2010",num_colors=1)
